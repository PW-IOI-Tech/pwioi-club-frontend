// app/teacher/TeacherHomePageClient.tsx
...
const TeacherHomePageClient = () => {
        ...
        try {
          ...
          if (err.response?.status === 401) {
            ...
            const refreshRes = await axios.post(
              ...
              { token: refreshToken }, // Fixed spacing
              { withCredentials: true }
            );
  ...
  return <TeacherHome userDetails={userDetails} />;
};

export default TeacherHomePageClient;
